...
global $row;
  ...
  if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO leaves(name, descr, fromdate, todate, status) VALUES('".$_SESSION['admin_name']."','".$reason."', '".$fromdate."', '".$todate."', '".$status."')";
    
      
      // $query = "INSERT INTO leaves(name, descr, fromdate, todate, status) VALUES({1},{$_SESSION['admin_name']},{$reason}, {$fromdate}, {$todate}, {$status})";
...
<body>
  ...
  <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" href="#" style="color:black; font-weight: bold;">Menon</a>
      <ul class="nav justify-content-end">
           
            <li class="nav-item">
                <a class="nav-link" href="myhistory.php" style="color:black; font-weight: bold;">My Leave History</a>
            </li>
            <li class="nav-item">
