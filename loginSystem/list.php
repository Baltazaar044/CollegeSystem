        ...
        <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                          $leaves = mysqli_query($conn,"SELECT * FROM user_form ");
                          if($leaves){
                            ...
                            if($numrow!=0){
                              ...
                              while($row1 = mysqli_fetch_array($leaves)){
                                ...
                                echo "<tr>
                                        ...
                                        <td><a href=\"delete_pep.php?id={$row1['id']}\"><button class='btn-danger btn-sm' >Delete</button></a></td>
