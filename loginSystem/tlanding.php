                ...
                <div class="grid-item-1">
                    ...
                    <div class="btn_wrapper">
                        <button class="btn view_more_btn"
                            onclick="window.location.href='https://localhost:81/loginsystem/resume_generator.php';">
                            resume generator<i class="ri-arrow-right-line"></i>
                        </button>
                        <button class="btn documentation_btn"
                            onclick="window.location.href='https://localhost:8!/loginsystem/test2.php';">Calculator</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        ...
        <div class="cards">
         <div class="card card-1">
            ...
            <h2>
                <a href="https://localhost/loginsystem/tannouncements.php">Make Announcement</a>
            </h2>
        </div>
        ...
        <div class="card card-3">
            ...
            <h2>
                <a href="https://localhost/loginsystem/upload.php">Question Paper Submission</a>
            </h2>
        </div>
        ...
        <div class="card card-4">
            ...
            <h2>
                <a href="https://localhost/loginsystem/quizLogin.php">Online Exam</a>
            </h2>
        </div>
